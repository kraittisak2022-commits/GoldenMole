...
- Name: sand-round-flow.spec.ts >> assign washHome + batch allocation saves successfully
- Location: e2e\sand-round-flow.spec.ts:3:1
...
Call log:
  - waiting for getByLabel('จำนวนถังที่ได้วันนี้').locator('input')
...
- generic [ref=e3]:
  ...
  - generic [ref=e10]:
    ...
    - generic [ref=e75]:
      - generic [ref=e78]:
        - status [ref=e80]: บันทึกล่าสุด 15:37
        - generic [ref=e81]:
          - generic [ref=e82]:

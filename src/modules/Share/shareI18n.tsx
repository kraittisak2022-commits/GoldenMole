...
const messages = {
    th: {
        ...
        remainingRounds: 'เหลือ {n} คิว',
        etaReachTarget: 'คาดการณ์ถึงเป้าประมาณ {time}',
        ...
        tripTargetLabel: 'เป้าหมาย 250 เที่ยว/วัน',
        sandTargetLabel: 'เป้าหมาย 1000 คิว/วัน',
        targetProgress: '{current}/{target}',
        tripTargetProgress: '{current}/{target} เที่ยว',
        sandTargetProgress: '{current}/{target} คิว',
        ...
        attendanceGroupSand: 'พนักงานท่าทราย',
        attendanceGroupDriver: 'พนักงานขับรถแม็คโคร',
        attendanceGroupOther: 'อื่นๆ',
        close: 'ปิด',
        manage: 'จัดการ',
        manageRounds: 'จัดการรอบ',
        lapIntervalLabel: 'รอบ {from}→{to}',
        personUnit: 'คน',
        vehicleUnit: 'คัน',
        litersUnit: 'ลิตร',
        deviceNameLabel: 'ชื่ออุปกรณ์นี้',
        deviceNamePlaceholder: 'เช่น มือถือหัวหน้างาน',
        deviceNameSave: 'บันทึกชื่อ',
        deviceNameSaved: 'บันทึกชื่ออุปกรณ์แล้ว',
        dayOpsBriefTitle: 'สรุปวันนี้',
        dayOpsTripVehicles: 'รถเที่ยวที่ใช้งาน',
        dayOpsTripVehiclesValue: '{n} คัน',
        dayOpsMacroVehicles: 'รถแม็คโครที่ใช้งาน',
        dayOpsMacroVehiclesValue: '{n} คัน',
        dayOpsSandMachine: 'เครื่องร่อนทราย',
        sandMachineHours: 'เริ่ม {start} · ปิด {end}',
        sandMachineStartOnly: 'เริ่ม {start}',
        sandMachineNoData: 'ยังไม่มีข้อมูลเวลา',
    },
    zh: {
        langShort: '中文',
        langToggle: 'TH',
        ...
        remainingRounds: '还剩 {n} 斗',
        etaReachTarget: '预计约 {time} 达标',
        targetReached: '已达目标',
        paceSteady: '节奏稳定',
        paceUneven: '节奏不稳',
        paceModerate: '节奏一般',
        ...
        targetLabel: '目标',
        tripTargetLabel: '目标 250 趟/天',
        sandTargetLabel: '目标 1000 斗/天',
        targetProgress: '{current}/{target}',
        tripTargetProgress: '{current}/{target} 趟',
        sandTargetProgress: '{current}/{target} 斗',
        ...
        attendanceGroupSand: '砂场员工',
        attendanceGroupDriver: '挖掘机司机',
        attendanceGroupOther: '其他',
        close: '关闭',
        manage: '管理',
        manageRounds: '管理轮次',
        lapIntervalLabel: '第 {from}→{to} 轮',
        personUnit: '人',
        vehicleUnit: '辆',
        litersUnit: '升',
        deviceNameLabel: '本设备名称',
        deviceNamePlaceholder: '例如：主管手机',
        deviceNameSave: '保存名称',
        deviceNameSaved: '设备名称已保存',
        dayOpsBriefTitle: '今日摘要',
        dayOpsTripVehicles: '趟次车辆',
        dayOpsTripVehiclesValue: '{n} 辆',
        dayOpsMacroVehicles: '挖掘机',
        dayOpsMacroVehiclesValue: '{n} 辆',
        dayOpsSandMachine: '洗沙机',
        sandMachineHours: '开始 {start} · 结束 {end}',
        sandMachineStartOnly: '开始 {start}',
        sandMachineNoData: '暂无时间数据',
    },
} as const;

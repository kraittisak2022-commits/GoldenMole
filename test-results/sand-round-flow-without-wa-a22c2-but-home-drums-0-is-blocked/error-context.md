...
- Name: sand-round-flow.spec.ts >> without washHome assignment but home drums > 0 is blocked
- Location: e2e\sand-round-flow.spec.ts:12:1
...
Call log:
  - waiting for getByLabel('จำนวนทรายที่ล้างที่บ้านวันนี้').locator('input')
...
- generic [ref=e3]:
  ...
  - generic [ref=e10]:
    ...
    - generic [ref=e75]:
      - generic [ref=e78]:
        - status [ref=e80]: บันทึกล่าสุด 15:38
        - generic [ref=e81]:
          - generic [ref=e82]:
      ...
      - generic [ref=e339]:
        ...
        - generic [ref=e372]:
          ...
          - generic [ref=e394]:
            ...
            - generic [ref=e401]:
              - paragraph [ref=e402]: ยังไม่ปิดรอบ
        ...
        - generic [ref=e404]:
          ...
          - list [ref=e422]:
            - listitem [ref=e423] [cursor=pointer]:
              - generic [ref=e424]: รอบที่ 1 · 20/04/2569 - 20/04/2569 · กำลังดำเนินการ
        ...
        - generic [ref=e427]:
          - generic [ref=e428]:
            ...
            - generic [ref=e439]:
              ...
              - text: วัน
            - button "ปิดรอบด้วยสิทธิ์ผู้ดูแล" [ref=e441] [cursor=pointer]
          - heading "รายละเอียดรอบที่ 1 แบบละเอียด" [level=5] [ref=e442]
          - generic [ref=e443]:
            - generic [ref=e444]: "Workflow:"
            - combobox [ref=e445]:
              - option "Open" [selected]
              - option "Reviewing"
              - option "Closed"
              - option "Reopened"
            - textbox "เหตุผล (บังคับเมื่อ Closed/Reopened)" [ref=e446]
          - generic [ref=e447]:
            - generic [ref=e448]:
          ...
          - generic [ref=e486]:
            ...
            - generic [ref=e488]:
              ...
              - button "merge" [ref=e493] [cursor=pointer]
            - generic [ref=e495]:
              - generic [ref=e496]:
              ...
              - generic [ref=e505]:
                ...
                - generic [ref=e507]:
                  - textbox [ref=e508]: BATCH-20260420
                  - generic [ref=e509]:
          ...
          - generic [ref=e515]:
            - heading "Audit Trail รอบล้างทราย" [level=6] [ref=e516]
            - paragraph [ref=e518]: ยังไม่มีประวัติการแก้ไข/ปิดรอบ
      - generic [ref=e520]:
        - heading "Dashboard mini trend (3 เดือนล่าสุด)" [level=4] [ref=e521]
        - generic [ref=e522]:
          - generic [ref=e523]:
            - generic [ref=e524]:
              - generic [ref=e525]: ม.ค. 69
              - generic [ref=e526]: Score 0
            - generic [ref=e528]: วันว่าง 31 | กลุ่มซ้ำ 0 | เคส 0
          - generic [ref=e529]:
            - generic [ref=e530]:
              - generic [ref=e531]: ก.พ. 69
              - generic [ref=e532]: Score 0
            - generic [ref=e534]: วันว่าง 28 | กลุ่มซ้ำ 0 | เคส 0
          - generic [ref=e535]:
            - generic [ref=e536]:
              - generic [ref=e537]: มี.ค. 69
              - generic [ref=e538]: Score 0
            - generic [ref=e540]: วันว่าง 31 | กลุ่มซ้ำ 0 | เคส 0
      - generic [ref=e542]:
        - generic [ref=e543]:
          - img [ref=e544]
        ...
        - generic [ref=e546]:
          - generic [ref=e547]:
            - generic [ref=e548]: ตั้งแต่
            - textbox "ตั้งแต่" [ref=e549]: 2026-03-11
          - generic [ref=e550]:
            - generic [ref=e551]: ถึง
            - textbox "ถึง" [ref=e552]: 2026-04-24
          - generic [ref=e553] [cursor=pointer]:
            - checkbox "ไม่นับวันอาทิตย์" [ref=e554]
            - generic [ref=e555]: ไม่นับวันอาทิตย์
          - generic [ref=e556] [cursor=pointer]:
            - checkbox "ซ่อนวันหยุดนักขัตฤกษ์" [ref=e557]
            - generic [ref=e558]: ซ่อนวันหยุดนักขัตฤกษ์
        - generic [ref=e559]:
          - generic [ref=e560]: "ตัวกรองความผิดปกติ:"
          - button "ทั้งหมด" [ref=e561] [cursor=pointer]
          - button "ดูเฉพาะวันไม่มีบันทึก" [ref=e562] [cursor=pointer]
          - button "ดูเฉพาะวันซ้ำ" [ref=e563] [cursor=pointer]
      - generic [ref=e566]:
        - generic [ref=e567]:
          - img [ref=e568]
          - generic [ref=e570]:
            - heading "ปฏิทินตรวจสอบ (คลิกวันที่เพื่อไป Daily Wizard)" [level=4] [ref=e571]
            - paragraph [ref=e572]: แดง = ไม่มีบันทึก, ส้ม = ซ้ำแบบตรงกัน, เหลือง = ซ้ำใกล้เคียง, เขียว = ปกติ
        - generic [ref=e573]:
          - generic [ref=e574]: อา.
          - generic [ref=e575]: จ.
          - generic [ref=e576]: อ.
          ...
          - generic [ref=e589]: "9"
          - generic [ref=e590]: "10"
          - button "11" [ref=e591] [cursor=pointer]
          - button "12" [ref=e592] [cursor=pointer]
          - button "13" [ref=e593] [cursor=pointer]
          - button "14" [ref=e594] [cursor=pointer]
          - button "15" [ref=e595] [cursor=pointer]
          - button "16" [ref=e596] [cursor=pointer]
          - button "17" [ref=e597] [cursor=pointer]
          - button "18" [ref=e598] [cursor=pointer]
          - button "19" [ref=e599] [cursor=pointer]
          - button "20" [ref=e600] [cursor=pointer]
          - button "21" [ref=e601] [cursor=pointer]
          - button "22" [ref=e602] [cursor=pointer]
          - button "23" [ref=e603] [cursor=pointer]
          - button "24" [ref=e604] [cursor=pointer]
          - button "25" [ref=e605] [cursor=pointer]
          - button "26" [ref=e606] [cursor=pointer]
          - button "27" [ref=e607] [cursor=pointer]
          - button "28" [ref=e608] [cursor=pointer]
          - button "29" [ref=e609] [cursor=pointer]
          - button "30" [ref=e610] [cursor=pointer]
          - button "31" [ref=e611] [cursor=pointer]
        - paragraph [ref=e616]: รวมวันไม่มีบันทึก 44 วัน | ซ้ำแบบตรงกัน 0 วัน | ซ้ำใกล้เคียง 0 วัน
      - generic [ref=e618]:
        - heading "กฎตรวจความสมเหตุสมผล (Rule Engine)" [level=4] [ref=e619]
        - paragraph [ref=e620]: "ตัวอย่างกฎ: รายรับเป็น 0, ค่าแรงสูงผิดปกติ, น้ำมันมากแต่ไม่มีเที่ยวรถ (ปรับ threshold ได้จากการ์ดสรุป)"
        - paragraph [ref=e621]: ไม่พบความผิดปกติจากกฎในช่วงที่เลือก
      - generic [ref=e623]:
        - heading "รายการที่น่าสงสัยว่าซ้ำกัน" [level=4] [ref=e624]
        - paragraph [ref=e625]: ตรวจทั้งแบบตรงกันทุกช่อง และแบบใกล้เคียงผิดปกติ (จำนวนเงิน/รายละเอียด/เวลา)
        - paragraph [ref=e626]: ไม่พบกลุ่มข้อมูลซ้ำในช่วงที่เลือก
      - generic [ref=e628]:
        - heading "แจ้งเตือน / สงสัยข้อมูลผิดพลาด" [level=4] [ref=e629]
        - paragraph [ref=e630]: สร้างเคสและติดตามสถานะได้ (ใหม่ / กำลังตรวจ / แก้แล้ว / ปิดเคส)
        - generic [ref=e632]:
          - generic [ref=e633]: วันที่อ้างอิง
          - textbox "วันที่อ้างอิง" [ref=e634]: 2026-04-24
        - textbox "เช่น วันนี้กรอกเที่ยวรถซ้ำ 2 ครั้ง / สงสัยรายรับวันที่ผิด..." [ref=e635]
        - button "บันทึกการแจ้งเตือน" [disabled] [ref=e636]
        - generic [ref=e637]:
          - text: หมายเหตุเวลาปรับสถานะเคส (ใช้ร่วมกับทุกแถว)
          - textbox "เช่น ตรวจข้อมูลย้อนหลังแล้วตรงกัน / แจ้งทีมแก้ไขแล้ว" [ref=e638]
      - generic [ref=e640]:
        - heading "Audit Trail ของเคสตรวจสอบ" [level=4] [ref=e641]
        - paragraph [ref=e642]: บันทึกว่าใครเปลี่ยนสถานะจากอะไรไปอะไร เมื่อไร และหมายเหตุ
        - paragraph [ref=e643]: ยังไม่มีประวัติการเปลี่ยนสถานะ
```
